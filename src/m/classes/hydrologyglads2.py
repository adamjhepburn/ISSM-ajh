...
class hydrologyglads2(object):
    """hydrologyglads2 class definition
    ...
    def __repr__(self):  # {{{
        s = '   GlaDS2 (hydrologyglads2) solution parameters:\n'
        s += '\t--SHEET\n'
        ...
        s += '{}\n'.format(fielddisplay(self, 'stabilization', 'stabilization tau for the water pressure solution update'))
    ...
    def defaultoutputs(self, md):  # {{{
        list = ['HydrologyWaterVx','HydrologyWaterVy',
        'HydrologySheetHeight','HydrologySheetDischarge','HydrologyWaterPressure',
        'HydraulicPotential','HydrologyFlowingSheetHeight','HydrologyMeanCavityHeight']
        return list
    # }}}
