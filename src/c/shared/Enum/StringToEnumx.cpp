...
int  StringToEnumx(const char* name,bool notfounderror){
   ...
   if(stage==6){
	      if (strcmp(name,"SmbPfac")==0) return SmbPfacEnum;
   ...
   if(stage==7){
	      if (strcmp(name,"AdjointxShear")==0) return AdjointxShearEnum;
   ...
   if(stage==8){
	      ...
	      else if (strcmp(name,"HydrologyElasticSheetThickness")==0) return HydrologyElasticSheetThicknessEnum;
	      else if (strcmp(name,"HydrologyElasticSheetThicknessOld")==0) return HydrologyElasticSheetThicknessOldEnum;
   ...
   if(stage==9){
	      if (strcmp(name,"LoadingforceZ")==0) return LoadingforceZEnum;
   ...
   if(stage==11){
	      if (strcmp(name,"SmbS0p")==0) return SmbS0pEnum;
   ...
   if(stage==12){
	      if (strcmp(name,"WaterPressureValuesAutoregression")==0) return WaterPressureValuesAutoregressionEnum;
